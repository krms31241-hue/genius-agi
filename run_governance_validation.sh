...
echo "========================================================"
echo "  SELF GOVERNANCE ENGINE — FULL PROJECT VALIDATION"
echo "========================================================"
...
" || true
    ...
    if ! python -m pytest tests/test_governance.py -v --tb=short; then
        echo "⚠ Governance tests failed. Applying auto-fix..."
...
echo "========================================================"
if [ "$PASS" = true ]; then
    echo "✅ GOVERNANCE ENGINE VALIDATION COMPLETE. ALL TESTS PASSED."
    echo "========================================================"
    exit 0
else
