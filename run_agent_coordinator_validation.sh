...
echo "========================================================"
echo "  MULTI-AGENT COORDINATOR — FULL PROJECT VALIDATION"
echo "========================================================"
...
" || true
    ...
    echo "▶ Running Agent Coordinator & Full Suite..."
    OUTPUT=$(python -m pytest tests/test_agent_coordinator.py tests/ -v --tb=short 2>&1) || true
    echo "$OUTPUT"
...
if [ "$PASS" = true ]; then
    ...
    echo "✅ MULTI-AGENT COORDINATOR VALIDATION PASSED"
